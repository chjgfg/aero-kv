...
pub async fn set_fee(
    ...
    info!("set fee base_fee: {}, fee_per_byte: {}, scan_fee_per_item: {}", req.base_fee, req.fee_per_byte, req.scan_fee_per_item);
    let _ = client
        .set_fee(req.base_fee, req.fee_per_byte, req.scan_fee_per_item)
        .await;
